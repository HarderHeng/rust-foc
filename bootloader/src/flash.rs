...
//!
//! Uses the raw STM32G4 PAC (via `embassy_stm32::pac`) for page erase and
//! 64-bit programming. STM32G4 page size is 2 KB.
//!
//! SAFETY: The bootloader has no concurrent work, so blocking flash operations
//! are safe. Unlock/lock sequences follow the STM32G4 reference manual.
